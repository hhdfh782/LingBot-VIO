...
from third_party.lingbot_map.layers.block import Block, FlashInferBlock, SDPABlock
from third_party.lingbot_map.layers.rope import WanRotaryPosEmbed
from third_party.lingbot_map.aggregator.base import AggregatorBase, slice_expand_and_flatten
...
class AggregatorStream(AggregatorBase):
    ...
    def _get_flashinfer_manager(self, device, dtype, tokens_per_frame=None):
        ...
        if self.kv_cache_manager is None:
            from third_party.lingbot_map.layers.flashinfer_cache import FlashInferKVCacheManager
